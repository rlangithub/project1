...
const LazyToDo=React.lazy(()=>import('./componets/tasks/tasks'))
  ...
  return (
    ...
    <Box sx={{ display: { xs: 'none', sm: 'block' }, '& :not(style)': { ml: 2} }}>
      ...
      <Routes>
        ...
        <Route path="/tasks"  element={<Suspense fallback={<h1>loading..</h1>}><LazyToDo/></Suspense>} />
